package net.lastcomrade0.glowing_obsidian;
...
@Mod(GlowingObsidian.MODID)
public class GlowingObsidian
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "glowing_obsidian";
    ...
    public GlowingObsidian()
    {
        ...
        //Register GlowingObsidianBlock
        GlowingObsidianBlock.register(modEventBus);

        //Register GlowingObsidianItem
        GlowingObsidianItem.register(modEventBus);
